...
subtitle: "Jeremy McWilliams" # change this!
...
add page header with info here
...
Now it's your turn. Create a vector named "observations", and have it contain the values 30, 20, 40, 15, and 50.
...
(share where people end up on google)
...
Knitted pdf - flush out, be clear about deliverable. naming conventions! And add name at top. 

assignment1-lastname.pdf

Due date: midnight on Monday, January 24th 

add readme on assignments, naming conventions, where to turn in,etc

That's it for today. If you need any help, please feel free to reach out to Jeremy at jeremym@lclark.edu.
